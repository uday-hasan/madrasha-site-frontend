...
export function AboutSummary() {
  ...
  const displayTitle = aboutSummary?.title || "আমাদের সম্পর্কে";
  const displayText1 = aboutSummary?.text1 || `${siteConfig.foundedYear} সালে প্রতিষ্ঠিত ${siteConfig.name} বাংলাদেশের অন্যতম প্রধান ইসলামী শিক্ষা প্রতিষ্ঠান। কুরআন, হাদিস ও আধুনিক শিক্ষার সমন্বয়ে আমরা গড়ে তুলছি আলোকিত প্রজন্ম।`;
  const displayText2 = aboutSummary?.text2 || `${siteConfig.yearsOfExcellence} বছরেরও বেশি সময় ধরে এই প্রতিষ্ঠান হাজারো শিক্ষার্থীকে ইসলামী জ্ঞানে সমৃদ্ধ করে আসছে। আমাদের অভিজ্ঞ শিক্ষক মণ্ডলী প্রতিটি শিক্ষার্থীর সার্বিক বিকাশে নিবেদিত।`;
  const displayValues = aboutSummary?.values && aboutSummary.values.length > 0 ? aboutSummary.values : staticValues;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {displayValues.map((value, index) => {
              const IconComponent = (Icons as any)[value.icon || "Info"] || Icons.Info;
