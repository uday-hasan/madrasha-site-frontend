      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              {siteConfig.phone.map((phone) => (
                <li key={phone} className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/admission" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                  ভর্তি তথ্য
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/notices" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                  নোটিশ বোর্ড
                </Link>
              </li>
              <li>
